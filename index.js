function init() {
	...
	$('#buddies button').click(function() {
		
		$('iframe').attr("src", $(this).attr('src'));
		$('#iframetitle').html($(this).attr('title'));
		
		$('#buddies button.selected').removeClass('selected');
		$(this).addClass('selected');

		//document.querySelector('#buddies li').setAttribute("aria-disabled", "false");
		//this.parentNode.parentNode.setAttribute("aria-disabled", "true");
	});
